...
async function generateQuestions(apiKey, jd, stage, focus) {
  ...
  const focusMap = {
    'jd-based questions': {
      type: 'JD-Based',
      count: 3,
      instruction: 'Generate questions pulled DIRECTLY from the specific skills, tools, responsibilities, and requirements listed in the job description. Examples: "The role requires experience with [specific tool] — walk me through how you have used it", "This position involves [specific responsibility] — tell me about your experience doing that." Every question must reference something explicitly mentioned in the JD.',
    },
